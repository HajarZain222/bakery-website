...
function QuotePost() {
    return (
        <>
            <header className="quote-post page-header">
                <div className="page-header-content">
                    <h2 className="page-title">Quote Post</h2>
            ...
            <section className="quote-post-content p-lg-5 p-3">
                <div className="container">

                    {/*  Main Quote Block  */}
                    <div className="py-lg-4 py-2 border-1 border-bottom">
                        <a href="/quote-post">
                            <blockquote className="blockquote mb-0 text-white p-5">
                        ...
                        <div className="quote position-relative border-4 border-start text-start ms-4 px-4 py-2">
                            ...
                            <p className="desc ms-3">
                                ...
                                vero eros et accumsam. Nam liber tempor cum soluta.
                            </p>
